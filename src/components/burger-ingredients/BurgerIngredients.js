    ...
    return (
        <div className={ styles.BurgerIngredients }>
            ...
            <div>
                ...
                <div className={ styles.Container }>
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ BunTwo } />
                    ...
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ BunOne }></img>
                        <div className={ styles.Price }><p className={ styles.PriceCoin } >20</p><CurrencyIcon type="primary" /></div>
            ...
            <div>
                ...
                <div className={ styles.Container }>
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ SauceTwo } />
                    ...
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ SauceFour }></img>
                        <div className={ styles.Price }><p className={ styles.PriceCoin } >30</p><CurrencyIcon type="primary" /></div>
                ...
                <div className={ styles.Container }>
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ SauceThree } />
                        <div className={ styles.Price }><p className={ styles.PriceCoin }>30</p><CurrencyIcon type="primary" /></div>
                        <p className={ styles.Name }>Соус-X</p>
                    </div>
                    <div className={ styles.Block }>
                        <img className="ml-4 mr-4" src={ SauceOne }></img>
                        <div className={ styles.Price }><p className={ styles.PriceCoin } >30</p><CurrencyIcon type="primary" /></div>
                        <p className={ styles.Name }>Соус-X</p>
                    </div>      
                </div>
